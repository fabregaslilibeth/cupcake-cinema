...
mongoose.connect('mongodb+srv://lilibethfabregas:batchoy08@cluster0-dyxdu.mongodb.net/cp3?retryWrites=true&w=majority', {useNewUrlParser: true});
...
//all reviews for admin decision to display or not
...
app.use('/reviews', passport.authenticate('jwt', {session: false}), review);

const booking = require('./routes/bookings');
app.use('/bookings', passport.authenticate('jwt', {session: false}), booking);
